...
class jenkins::cli {
  ...
  $grep_jarname = "JARNAME=\$(jar -tf ${jenkins::libdir}/jenkins.war | grep 'WEB-INF/lib/cli-.*\.jar')"
  $extract_jar = "jar -xf ${jenkins::libdir}/jenkins.war \$JARNAME"
  $move_jar = "mv \$JARNAME ${jar}"
